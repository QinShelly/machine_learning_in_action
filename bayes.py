...
def spamTest():
    ...
    for docIndex in testSet:
        ...
        if classifyNB(array(wordVector), p0V, p1V, pSpam) != classList[docIndex]:
            errorCount += 1
            print(docIndex, ' classified as ',  classifyNB(array(wordVector), p0V, p1V, pSpam), \
                  'but is actually', classList[docIndex])
...
if __name__ == '__main__':
    ...
    #spamTest()
    import feedparser
    ny = feedparser.parse('https://planetpython.org/rss20.xml')
    sf = feedparser.parse('https://www.thisiscolossal.com/feed/')
